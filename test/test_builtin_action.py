...
class TestBuiltinAction(unittest.TestCase):
    """BuiltinAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuiltinAction:
        """Test BuiltinAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuiltinAction`
        """
        model = BuiltinAction()
        if include_optional:
