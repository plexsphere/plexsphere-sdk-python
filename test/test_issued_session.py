...
class TestIssuedSession(unittest.TestCase):
    """IssuedSession unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IssuedSession:
        """Test IssuedSession
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IssuedSession`
        """
        model = IssuedSession()
        if include_optional:
