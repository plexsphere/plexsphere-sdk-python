...
class TestNodeStateExecution(unittest.TestCase):
    """NodeStateExecution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeStateExecution:
        """Test NodeStateExecution
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeStateExecution`
        """
        model = NodeStateExecution()
        if include_optional:
            return NodeStateExecution(
                execution_id = '',
                action = '',
                type = 'builtin',
                parameters = { },
    ...
    def testNodeStateExecution(self):
        """Test NodeStateExecution"""
