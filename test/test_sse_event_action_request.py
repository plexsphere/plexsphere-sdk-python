...
class TestSSEEventActionRequest(unittest.TestCase):
    """SSEEventActionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SSEEventActionRequest:
        """Test SSEEventActionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SSEEventActionRequest`
        """
        model = SSEEventActionRequest()
        if include_optional:
            return SSEEventActionRequest(
                event_id = '',
    ...
    def testSSEEventActionRequest(self):
        """Test SSEEventActionRequest"""
