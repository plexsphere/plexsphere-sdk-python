...
class TestBuiltinActionParameter(unittest.TestCase):
    """BuiltinActionParameter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuiltinActionParameter:
        """Test BuiltinActionParameter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuiltinActionParameter`
        """
        model = BuiltinActionParameter()
        if include_optional:
            return BuiltinActionParameter(
                name = '0',
                type = '',
                required = True,
                default = '',
    ...
    def testBuiltinActionParameter(self):
        """Test BuiltinActionParameter"""
