...
class TestDiscoveredHook(unittest.TestCase):
    """DiscoveredHook unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiscoveredHook:
        """Test DiscoveredHook
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiscoveredHook`
        """
        model = DiscoveredHook()
        if include_optional:
