...
class TestOperatorRevokeReason(unittest.TestCase):
    """OperatorRevokeReason unit test stubs"""
    ...
    def testOperatorRevokeReason(self):
        """Test OperatorRevokeReason"""
        # inst = OperatorRevokeReason()
