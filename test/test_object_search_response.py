...
class TestObjectSearchResponse(unittest.TestCase):
    """ObjectSearchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObjectSearchResponse:
        """Test ObjectSearchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObjectSearchResponse`
        """
        model = ObjectSearchResponse()
        if include_optional:
            return ObjectSearchResponse(
                items = [
                    plexsphere.models.object_search_result_item.ObjectSearchResultItem(
                        kind = '', 
                        id = '', )
                    ],
                next_cursor = '',
    ...
    def testObjectSearchResponse(self):
        """Test ObjectSearchResponse"""
