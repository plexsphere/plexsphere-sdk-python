...
class TestAPITokenIssueRequest(unittest.TestCase):
    """APITokenIssueRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> APITokenIssueRequest:
        """Test APITokenIssueRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `APITokenIssueRequest`
        """
        model = APITokenIssueRequest()
        if include_optional:
            return APITokenIssueRequest(
                identity_ref = 'service:55914d4d6Ea18e3e53E03fEE4Bc7d--c0d28',
                env_prefix = 'dev',
                ttl_seconds = 1
            )
        else:
    ...
    def testAPITokenIssueRequest(self):
        """Test APITokenIssueRequest"""
