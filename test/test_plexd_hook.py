...
class TestPlexdHook(unittest.TestCase):
    """PlexdHook unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlexdHook:
        """Test PlexdHook
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlexdHook`
        """
        model = PlexdHook()
        if include_optional:
            return PlexdHook(
