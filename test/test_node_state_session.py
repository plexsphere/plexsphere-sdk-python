...
class TestNodeStateSession(unittest.TestCase):
    """NodeStateSession unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeStateSession:
        """Test NodeStateSession
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeStateSession`
        """
        model = NodeStateSession()
        if include_optional:
            return NodeStateSession(
                session_id = '',
                jti = '',
                kind = 'ssh',
