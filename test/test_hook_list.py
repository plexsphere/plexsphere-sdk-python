...
class TestHookList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HookList:
        """Test HookList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HookList`
        """
        model = HookList()
        if include_optional:
            return HookList(
                items = [
                    plexsphere.models.discovered_hook.DiscoveredHook(
                        node_id = '', 
                        domain_id = '', 
                        name = '', 
