...
class TestObjectSearchResultItem(unittest.TestCase):
    """ObjectSearchResultItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObjectSearchResultItem:
        """Test ObjectSearchResultItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObjectSearchResultItem`
        """
        model = ObjectSearchResultItem()
        if include_optional:
            return ObjectSearchResultItem(
                kind = '',
                id = ''
            )
        else:
    ...
    def testObjectSearchResultItem(self):
        """Test ObjectSearchResultItem"""
