...
> delete_node_state_report(id, key)
...
with plexsphere.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete an upstream node-state report entry for a Node.
        api_instance.delete_node_state_report(id, key)
...
the operator dashboard "manual key-rotation with impact preview"
...
# **get_node_secret**
> bytes get_node_secret(id, name, version=version)
...
The handler:
  ...
  1. Authenticates the caller against the Node Secret Key (NSK)
     ...
     pipeline.
  2. Applies the per-Node and per-Domain rate limits, resolves
     the addressed secret metadata, and runs the ReBAC hard
     gate — the caller must hold the `read` relation on the
     resolved `secret:<id>`.
...
with plexsphere.ApiClient(configuration) as api_client:
    ...
    try:
        # Fetch a Secret Store entry rewrapped under the calling Node's NSK.
        api_response = api_instance.get_node_secret(id, name, version=version)
        print("The response of MeshApi->get_node_secret:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MeshApi->get_node_secret: %s\n" % e)
```
...
**401** | The NSK credential in the &#x60;Authorization: Bearer&#x60; header was rejected. The Problem body&#39;s &#x60;code&#x60; field disambiguates the cause: &#x60;unauthorized&#x60; when the header is missing or malformed, &#x60;nsk_invalid&#x60; when the presented NSK cannot be resolved, and &#x60;nsk_revoked&#x60; when it resolves to a revoked NSK.  |  -  |
**403** | The NSK authenticates successfully but the calling Node lacks the &#x60;read&#x60; ReBAC relation on the addressed secret. The PermissionDenied body carries the ReBAC denial &#x60;reason&#x60; and the &#x60;correlation_id&#x60; that pairs with the audit entry. Unauthenticated callers cannot probe names; an authenticated but unauthorized Node can still distinguish a missing name (404) from a denied one (403) — a trade-off imposed by the ReBAC object being the resolved secret id.  |  -  |
...
**429** | The per-Node or per-Domain secret-fetch rate-limit bucket is exhausted. The Problem body&#39;s &#x60;code&#x60; field is one of &#x60;per_node_rate_limited&#x60; or &#x60;per_domain_rate_limited&#x60;, and the &#x60;Retry-After&#x60; response header carries the number of seconds the caller should wait before retrying.  |  * Retry-After - Seconds the caller should wait before retrying, derived from the collector&#39;s sample interval.  <br>  |
...
# **post_node_audit**
> IngestReceipt post_node_audit(id, audit_event, x_plexsphere_sent_at=x_plexsphere_sent_at)
...
with plexsphere.ApiClient(configuration) as api_client:
    ...
    try:
        # Ingest a batch of normalised audit events for a Node.
        api_response = api_instance.post_node_audit(id, audit_event, x_plexsphere_sent_at=x_plexsphere_sent_at)
...
**429** | A quota bucket is exhausted. The Problem body&#39;s &#x60;code&#x60; field is &#x60;per_node_rate_limited&#x60; when the per-Node byte budget is exhausted or &#x60;capacity_exceeded&#x60; when the per-Domain byte budget is exhausted, and the &#x60;Retry-After&#x60; response header carries the number of seconds the caller should wait before retrying.  |  * Retry-After - Seconds the caller should wait before retrying, derived from the collector&#39;s sample interval.  <br>  |
...
**503** | The ingest buffer could not accept the batch — the stream backend is unreachable or saturated. The Problem body&#39;s &#x60;code&#x60; field is &#x60;ingest_buffer_unavailable&#x60;, and the &#x60;Retry-After&#x60; response header carries the number of seconds the caller should wait before retrying.  |  * Retry-After - Seconds the caller should wait before retrying, derived from the collector&#39;s sample interval.  <br>  |
**500** | Internal server error. Body is a &#x60;Problem&#x60; with &#x60;code: internal&#x60;.  |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)

# **post_node_heartbeat**
> HeartbeatResponse post_node_heartbeat(id, heartbeat_request)
...
with plexsphere.ApiClient(configuration) as api_client:
    ...
    try:
        # Record a Node liveness heartbeat and return reconcile/rotate hints.
        api_response = api_instance.post_node_heartbeat(id, heartbeat_request)
...
> IntegrityViolationsResponse post_node_integrity_violations(id, integrity_violations_request)
...
with plexsphere.ApiClient(configuration) as api_client:
    ...
    try:
        # Ingest a batch of integrity-violation reports for a Node.
        api_response = api_instance.post_node_integrity_violations(id, integrity_violations_request)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Integrity-violation batch recorded. Every violation row has been persisted and the dedicated &#x60;integrity_alert&#x60; outbox event has been appended inside the same transaction before this response is written — the work is synchronous, so the status is 200, not 202.  |  -  |
**400** | Integrity-violation body failed structural validation. The Problem body&#39;s &#x60;code&#x60; field disambiguates the cause and is one of the following exhaustive enum values:    - &#x60;malformed_integrity_violations_request&#x60; — request     body cannot be decoded as an IntegrityViolationsRequest     envelope (invalid JSON, unknown field, missing     required field).   - &#x60;integrity_violations_empty&#x60; — the &#x60;violations&#x60; array     is empty after decoding.   - &#x60;integrity_violation_kind_invalid&#x60; — an entry&#39;s &#x60;kind&#x60;     is not in &#x60;{binary_checksum, hook_checksum,     ssh_host_key}&#x60;.   - &#x60;integrity_violation_kind_mismatch&#x60; — a &#x60;binary_checksum&#x60;     or &#x60;hook_checksum&#x60; entry carries a fingerprint field,     or an &#x60;ssh_host_key&#x60; entry carries a checksum field.   - &#x60;integrity_violation_detected_by_invalid&#x60; — an entry&#39;s     &#x60;detected_by&#x60; is not in &#x60;{startup_scan, inotify,     pre_dispatch}&#x60;.   - &#x60;integrity_violation_artifact_id_empty&#x60; — an entry&#39;s     &#x60;artifact_id&#x60; is empty or whitespace-only.   - &#x60;integrity_violation_checksum_invalid&#x60; — an entry&#39;s     &#x60;observed_checksum&#x60; or &#x60;expected_checksum&#x60; is missing     or does not decode to exactly 32 bytes.   - &#x60;integrity_violation_host_key_fingerprint_invalid&#x60; —     an entry&#39;s &#x60;observed_fingerprint&#x60; or     &#x60;expected_fingerprint&#x60; is non-empty and does not match     the canonical &#x60;SHA256:&lt;base64&gt;&#x60; form.  Generated clients can therefore exhaustively switch on &#x60;code&#x60; without a fall-through arm.  |  -  |
**401** | The NSK credential in the &#x60;Authorization: Bearer&#x60; header was rejected. The Problem body&#39;s &#x60;code&#x60; field disambiguates the cause: &#x60;unauthorized&#x60; when the header is missing or malformed, &#x60;nsk_invalid&#x60; when the presented NSK cannot be resolved, and &#x60;nsk_revoked&#x60; when it resolves to a revoked NSK. A handler-level defensive arm also answers &#x60;unauthorized&#x60; when no resolved Node reached the request context (a misconfigured route or bypassed middleware).  Generated clients can exhaustively switch on &#x60;code&#x60; without a fall-through arm. The example below illustrates the canonical &#x60;nsk_revoked&#x60; path.  |  -  |
**403** | The NSK in the &#x60;Authorization: Bearer&#x60; header authenticates successfully but belongs to a different Node than the path &#x60;id&#x60;. The PermissionDenied body&#39;s &#x60;code&#x60; field is &#x60;node_id_mismatch&#x60; so a leaked NSK cannot be replayed against a sibling Node.  |  -  |
...
**413** | The request is too large in bytes or in entries. The Problem body&#39;s &#x60;code&#x60; field disambiguates: &#x60;integrity_violations_body_too_large&#x60; (the raw body exceeded the 32 KiB ceiling, refused before the JSON decoder runs) or &#x60;integrity_violations_too_many&#x60; (the decoded &#x60;violations&#x60; array exceeds the per-batch cap of 128 entries — the same status class the metrics/logs/audit ingest surfaces use for a batch overflow).  |  -  |
...
# **post_node_logs**
> IngestReceipt post_node_logs(id, log_line, x_plexsphere_sent_at=x_plexsphere_sent_at)
...
with plexsphere.ApiClient(configuration) as api_client:
    ...
    try:
        # Ingest a batch of structured log lines for a Node.
        api_response = api_instance.post_node_logs(id, log_line, x_plexsphere_sent_at=x_plexsphere_sent_at)
...
# **post_node_metrics**
> IngestReceipt post_node_metrics(id, metric_sample, x_plexsphere_sent_at=x_plexsphere_sent_at)
...
with plexsphere.ApiClient(configuration) as api_client:
    ...
    try:
        # Ingest a batch of metric samples for a Node.
        api_response = api_instance.post_node_metrics(id, metric_sample, x_plexsphere_sent_at=x_plexsphere_sent_at)
...
> CapabilityManifestResponse put_node_capabilities(id, capability_manifest_request)
...
with plexsphere.ApiClient(configuration) as api_client:
    ...
    try:
        # Record the per-Node capability manifest snapshot.
        api_response = api_instance.put_node_capabilities(id, capability_manifest_request)
...
# **put_node_endpoint**
> EndpointResponse put_node_endpoint(id, endpoint_request)
...
Node. The handler:
  ...
  4. Validates the body — `reported_at` MUST be within 60s of
     ...
     1..65535 port range and a non-loopback IPv4/IPv6
...
with plexsphere.ApiClient(configuration) as api_client:
    ...
    try:
        # Record a NAT-observed Peer endpoint observation.
        api_response = api_instance.put_node_endpoint(id, endpoint_request)
...
> NodeStateReportResponse put_node_state_report(id, key, node_state_report_request)
...
with plexsphere.ApiClient(configuration) as api_client:
    ...
    try:
        # Record an upstream node-state report entry for a Node.
        api_response = api_instance.put_node_state_report(id, key, node_state_report_request)
...
**400** | The request body is malformed, the key violates the entry grammar, or the value exceeds the 4096-byte ceiling. The Problem body&#39;s &#x60;code&#x60; field is &#x60;invalid_report&#x60;.  |  -  |
**401** | The NSK credential in the &#x60;Authorization: Bearer&#x60; header was rejected. The Problem body&#39;s &#x60;code&#x60; field disambiguates the cause: &#x60;unauthorized&#x60; when the header is missing or malformed, &#x60;nsk_invalid&#x60; when the presented NSK cannot be resolved, and &#x60;nsk_revoked&#x60; when it resolves to a revoked NSK.  |  -  |
...
**409** | The per-Node report quota is exhausted — the write would push the Node past its stored-entry cap. The Problem body&#39;s &#x60;code&#x60; field is &#x60;report_quota_exceeded&#x60;. Retrying does not help until the workload deletes stored reports; the cap is an accumulation limit, not a rate limit.  |  -  |
