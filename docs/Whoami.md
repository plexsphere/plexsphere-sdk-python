...
**email** | **str** | Primary email of the principal as projected by the upstream IdP at sign-in. Omitted when the IdP did not supply an &#x60;email&#x60; claim or the principal is a ServiceIdentity. The dashboard&#39;s SignedInBadge renders it as the human-readable identity label.  | [optional] 
