...
**acme_account_ref** | **str** | Optional opaque reference to the ACME account used to issue the rule&#39;s certificate. Absent means the operator supplies certificates out of band.  | [optional] 
