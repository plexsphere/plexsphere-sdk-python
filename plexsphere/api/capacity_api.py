...
class CapacityApi:
    ...
    def get_domain_capacity(
        ...
        _param = self._get_domain_capacity_serialize(
            domain_id=domain_id,
    ...
    @validate_call
    def get_domain_capacity_with_http_info(
        self,
        domain_id: Annotated[UUID, Field(description="Owning Domain identifier (UUIDv7). Bound on the Domain-scoped operator surfaces — capacity, mesh topology, managed-push, observability queries, alert rules, and incidents. ")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DomainCapacitySnapshot]:
        """Return the capacity-and-scale snapshot for a Domain.
    ...
    @validate_call
    def get_domain_capacity_without_preload_content(
        self,
        domain_id: Annotated[UUID, Field(description="Owning Domain identifier (UUIDv7). Bound on the Domain-scoped operator surfaces — capacity, mesh topology, managed-push, observability queries, alert rules, and incidents. ")],
        _request_timeout: Union[
            None,
    ...
    def _get_domain_capacity_serialize(
        self,
        domain_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/domains/{domain_id}/capacity',
