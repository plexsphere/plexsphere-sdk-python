...
class AuditApi:
    ...
    def erase_identity_from_audit(
        self,
        domain_id: Annotated[UUID, Field(description="Owning Domain of the addressed audit chain. The Domain audit log is per-Domain by residency contract — cross-Domain decisions land in EACH affected Domain's chain; rows with platform residency live on the separate chain served under `/v1/platform/audit`. ")],
        ...
        :param domain_id: Owning Domain of the addressed audit chain. The Domain audit log is per-Domain by residency contract — cross-Domain decisions land in EACH affected Domain's chain; rows with platform residency live on the separate chain served under `/v1/platform/audit`.  (required)
        :type domain_id: UUID
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AuditEraseIdentityResponse",
            '400': "Problem",
            '401': "Problem",
    ...
    def _erase_identity_from_audit_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/domains/{domain_id}/audit/erase-identity',
    ...
    def _get_audit_entry_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/domains/{domain_id}/audit/entries/{seq}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_audit_entries(
        ...
        subject: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="Filter by subject pseudonym (64 lowercase hex characters). The query service never accepts plaintext subject ids; rows are pseudonymised at the sink boundary, so callers filter by the pseudonym as returned on previously read entries. ")] = None,
        ...
        :type limit: int
        :param subject: Filter by subject pseudonym (64 lowercase hex characters). The query service never accepts plaintext subject ids; rows are pseudonymised at the sink boundary, so callers filter by the pseudonym as returned on previously read entries. 
        :type subject: str
    ...
    def _list_audit_entries_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/domains/{domain_id}/audit/entries',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _verify_audit_chain_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/domains/{domain_id}/audit/verify',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
