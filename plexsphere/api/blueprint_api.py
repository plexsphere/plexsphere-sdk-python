...
class BlueprintApi:
    ...
    def get_blueprint(
        self,
        id: Annotated[UUID, Field(description="Blueprint identifier (UUIDv7). Bound on `/v1/blueprints/{id}` for the Blueprint Catalog read surface and on `/v1/blueprints/{id}/versions` for the version-publishing authorship surface. ")],
        ...
        :param id: Blueprint identifier (UUIDv7). Bound on `/v1/blueprints/{id}` for the Blueprint Catalog read surface and on `/v1/blueprints/{id}/versions` for the version-publishing authorship surface.  (required)
        :type id: UUID
