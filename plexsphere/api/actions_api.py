...
class ActionsApi:
    ...
    def post_node_execution_callback(
        ...
        execution_id: Annotated[UUID, Field(description="Execution identifier (UUIDv7) the callback settles.")],
        ...
        :type id: UUID
        :param execution_id: Execution identifier (UUIDv7) the callback settles. (required)
        :type execution_id: UUID
    ...
    def _post_node_execution_callback_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/nodes/{id}/executions/{execution_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
