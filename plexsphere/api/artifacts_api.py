...
class ArtifactsApi:
    ...
    @validate_call
    def get_plexd_artifact(
        self,
        version: Annotated[StrictStr, Field(description="plexd release version the registry indexes — the upstream release tag, for example a semver tag such as `v1.4.2`. Bound on `/v1/artifacts/plexd/{version}` and its `.sigstore` companion for the read-only plexd release registry surface. ")],
        authorization: Annotated[StrictStr, Field(description="`Bearer <access token>` — the operator bearer credential the request authenticates with. A missing, malformed, or rejected token surfaces as `401`. ")],
        ...
        :type version: str
        :param authorization: `Bearer <access token>` — the operator bearer credential the request authenticates with. A missing, malformed, or rejected token surfaces as `401`.  (required)
        ...
        _param = self._get_plexd_artifact_serialize(
            version=version,
    ...
    @validate_call
    def get_plexd_artifact_with_http_info(
        self,
        version: Annotated[StrictStr, Field(description="plexd release version the registry indexes — the upstream release tag, for example a semver tag such as `v1.4.2`. Bound on `/v1/artifacts/plexd/{version}` and its `.sigstore` companion for the read-only plexd release registry surface. ")],
        authorization: Annotated[StrictStr, Field(description="`Bearer <access token>` — the operator bearer credential the request authenticates with. A missing, malformed, or rejected token surfaces as `401`. ")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_plexd_artifact_without_preload_content(
        self,
        version: Annotated[StrictStr, Field(description="plexd release version the registry indexes — the upstream release tag, for example a semver tag such as `v1.4.2`. Bound on `/v1/artifacts/plexd/{version}` and its `.sigstore` companion for the read-only plexd release registry surface. ")],
        authorization: Annotated[StrictStr, Field(description="`Bearer <access token>` — the operator bearer credential the request authenticates with. A missing, malformed, or rejected token surfaces as `401`. ")],
        _request_timeout: Union[
    ...
    def _get_plexd_artifact_serialize(
        self,
        version,
        authorization,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/artifacts/plexd/{version}',
    ...
    @validate_call
    def get_plexd_artifact_signature(
        self,
        version: Annotated[StrictStr, Field(description="plexd release version the registry indexes — the upstream release tag, for example a semver tag such as `v1.4.2`. Bound on `/v1/artifacts/plexd/{version}` and its `.sigstore` companion for the read-only plexd release registry surface. ")],
        authorization: Annotated[StrictStr, Field(description="`Bearer <access token>` — the operator bearer credential the request authenticates with. A missing, malformed, or rejected token surfaces as `401`. ")],
        _request_timeout: Union[
        ...
        _param = self._get_plexd_artifact_signature_serialize(
            version=version,
            authorization=authorization,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_plexd_artifact_signature_with_http_info(
        self,
        version: Annotated[StrictStr, Field(description="plexd release version the registry indexes — the upstream release tag, for example a semver tag such as `v1.4.2`. Bound on `/v1/artifacts/plexd/{version}` and its `.sigstore` companion for the read-only plexd release registry surface. ")],
        authorization: Annotated[StrictStr, Field(description="`Bearer <access token>` — the operator bearer credential the request authenticates with. A missing, malformed, or rejected token surfaces as `401`. ")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_plexd_artifact_signature_without_preload_content(
        self,
        version: Annotated[StrictStr, Field(description="plexd release version the registry indexes — the upstream release tag, for example a semver tag such as `v1.4.2`. Bound on `/v1/artifacts/plexd/{version}` and its `.sigstore` companion for the read-only plexd release registry surface. ")],
        authorization: Annotated[StrictStr, Field(description="`Bearer <access token>` — the operator bearer credential the request authenticates with. A missing, malformed, or rejected token surfaces as `401`. ")],
        _request_timeout: Union[
    ...
    def _get_plexd_artifact_signature_serialize(
        self,
        version,
        authorization,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/artifacts/plexd/{version}/sigstore',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_plexd_artifacts(
        ...
        _param = self._list_plexd_artifacts_serialize(
            authorization=authorization,
            cursor=cursor,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def list_plexd_artifacts_with_http_info(
        self,
        authorization: Annotated[StrictStr, Field(description="`Bearer <access token>` — the operator bearer credential the request authenticates with. A missing, malformed, or rejected token surfaces as `401`. ")],
        cursor: Annotated[Optional[StrictStr], Field(description="Opaque continuation token returned by a previous call's `next_cursor`. The encoding is HMAC-signed by the server so a tampered cursor surfaces as `400`. ")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Maximum number of items to return in a single page. The handler clamps the value to [1, 200] before forwarding it to the read service. ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PlexdArtifactRefList]:
        """List indexed plexd releases.
    ...
    @validate_call
    def list_plexd_artifacts_without_preload_content(
        self,
        authorization: Annotated[StrictStr, Field(description="`Bearer <access token>` — the operator bearer credential the request authenticates with. A missing, malformed, or rejected token surfaces as `401`. ")],
        cursor: Annotated[Optional[StrictStr], Field(description="Opaque continuation token returned by a previous call's `next_cursor`. The encoding is HMAC-signed by the server so a tampered cursor surfaces as `400`. ")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=200, strict=True, ge=1)]], Field(description="Maximum number of items to return in a single page. The handler clamps the value to [1, 200] before forwarding it to the read service. ")] = None,
    ...
    def _list_plexd_artifacts_serialize(
        self,
        authorization,
        cursor,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/artifacts/plexd',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
