...
class ObservabilityApi:
    ...
    def append_incident_event(
        ...
        incident_id: Annotated[UUID, Field(description="Incident identifier (UUIDv7). Bound on `/v1/domains/{domain_id}/incidents/{incident_id}`, its `/events` sub-resource, and its `:resolve` sub-resource. ")],
        ...
        :type domain_id: UUID
        :param incident_id: Incident identifier (UUIDv7). Bound on `/v1/domains/{domain_id}/incidents/{incident_id}`, its `/events` sub-resource, and its `:resolve` sub-resource.  (required)
    ...
    def _append_incident_event_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/domains/{domain_id}/incidents/{incident_id}/events',
    ...
    def _create_alert_rule_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/domains/{domain_id}/alert-rules',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_alert_rule(
        self,
        domain_id: Annotated[UUID, Field(description="Owning Domain identifier (UUIDv7). Bound on the Domain-scoped operator surfaces — capacity, mesh topology, managed-push, observability queries, alert rules, and incidents. ")],
        alert_rule_id: Annotated[UUID, Field(description="Alert rule identifier (UUIDv7). Bound on `/v1/domains/{domain_id}/alert-rules/{alert_rule_id}` for the single-rule read, update, and delete. ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param domain_id: Owning Domain identifier (UUIDv7). Bound on the Domain-scoped operator surfaces — capacity, mesh topology, managed-push, observability queries, alert rules, and incidents.  (required)
        :type domain_id: UUID
        :param alert_rule_id: Alert rule identifier (UUIDv7). Bound on `/v1/domains/{domain_id}/alert-rules/{alert_rule_id}` for the single-rule read, update, and delete.  (required)
    ...
    def _delete_alert_rule_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/domains/{domain_id}/alert-rules/{alert_rule_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_incident_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/domains/{domain_id}/incidents/{incident_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_incidents_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/domains/{domain_id}/incidents',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _query_domain_logs_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/domains/{domain_id}/logs/query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _query_domain_metrics_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/domains/{domain_id}/metrics/query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _resolve_incident_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/domains/{domain_id}/incidents/{incident_id}/resolve',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
