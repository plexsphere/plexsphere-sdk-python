...
class TenancyApi:
    ...
    def get_identity(
        self,
        id: Annotated[UUID, Field(description="Domain identifier (UUIDv7). Bound on `/v1/domains/{id}` for the tenancy CRUD surface. ")],
        principal_id: Annotated[UUID, Field(description="Principal identifier (UUIDv7). Bound on `/v1/domains/{id}/identities/{principal_id}` for the per-Domain identity-read surface. ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Domain identifier (UUIDv7). Bound on `/v1/domains/{id}` for the tenancy CRUD surface.  (required)
        :type id: UUID
        :param principal_id: Principal identifier (UUIDv7). Bound on `/v1/domains/{id}/identities/{principal_id}` for the per-Domain identity-read surface.  (required)
    ...
    def _get_identity_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/domains/{id}/identities/{principal_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_invitation(
        self,
        id: Annotated[UUID, Field(description="Domain identifier (UUIDv7). Bound on `/v1/domains/{id}` for the tenancy CRUD surface. ")],
        invitation_id: Annotated[UUID, Field(description="Invitation identifier (UUIDv7). Bound on `/v1/domains/{id}/invitations/{invitation_id}` for the per- Domain invitation read / revoke surface. ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Domain identifier (UUIDv7). Bound on `/v1/domains/{id}` for the tenancy CRUD surface.  (required)
        :type id: UUID
        :param invitation_id: Invitation identifier (UUIDv7). Bound on `/v1/domains/{id}/invitations/{invitation_id}` for the per- Domain invitation read / revoke surface.  (required)
    ...
    def _get_invitation_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/domains/{id}/invitations/{invitation_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
