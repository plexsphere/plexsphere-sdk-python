...
class TenancyApi:
    ...
    def create_service_identity(
        self,
        id: Annotated[UUID, Field(description="Domain identifier (UUIDv7). Bound on `/v1/domains/{id}` for the tenancy CRUD surface. ")],
        service_identity_create_request: ServiceIdentityCreateRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Domain identifier (UUIDv7). Bound on `/v1/domains/{id}` for the tenancy CRUD surface.  (required)
        :type id: UUID
        :param service_identity_create_request: (required)
        :type service_identity_create_request: ServiceIdentityCreateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_service_identity_serialize(
            id=id,
            service_identity_create_request=service_identity_create_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def create_service_identity_with_http_info(
        self,
        id: Annotated[UUID, Field(description="Domain identifier (UUIDv7). Bound on `/v1/domains/{id}` for the tenancy CRUD surface. ")],
        service_identity_create_request: ServiceIdentityCreateRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def create_service_identity_without_preload_content(
        self,
        id: Annotated[UUID, Field(description="Domain identifier (UUIDv7). Bound on `/v1/domains/{id}` for the tenancy CRUD surface. ")],
        service_identity_create_request: ServiceIdentityCreateRequest,
        _request_timeout: Union[
    ...
    def _create_service_identity_serialize(
        self,
        id,
        service_identity_create_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if service_identity_create_request is not None:
            _body_params = service_identity_create_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/domains/{id}/service-identities',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
