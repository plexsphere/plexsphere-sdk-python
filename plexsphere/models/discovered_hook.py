...
class DiscoveredHook(BaseModel):
    ...
    image_digest: Annotated[str, Field(strict=True)] = Field(description="OCI image digest of the discovered hook image in canonical `sha256:<64 lowercase hex>` form. ")
