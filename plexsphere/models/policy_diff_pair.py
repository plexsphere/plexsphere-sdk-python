...
class PolicyDiffPair(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "before": PolicyRule.from_dict(obj["before"]) if obj.get("before") is not None else None,
            "after": PolicyRule.from_dict(obj["after"]) if obj.get("after") is not None else None
        })
