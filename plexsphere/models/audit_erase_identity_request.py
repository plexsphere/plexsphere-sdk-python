...
class AuditEraseIdentityRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    identity_id: UUID = Field(description="Identity whose `audit_subject_pii` mapping must be purged from the addressed chain. The pseudonym is derived server-side from the chain's scope anchor, `identity_id`, and the per-chain pepper; clients never compute it themselves. ")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["identity_id"]
