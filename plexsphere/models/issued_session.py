...
class IssuedSession(BaseModel):
    ...
    listener_endpoint: Optional[StrictStr] = Field(default=None, description="The on-Node endpoint (`host:port`) the operator's client connects to for this session kind. ")
    session: Session
