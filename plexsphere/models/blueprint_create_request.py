...
class BlueprintCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    slug: Annotated[str, Field(min_length=1, strict=True, max_length=63)] = Field(description="Kebab-case URL handle, unique across the catalogue. The aggregate's `ParseSlug` enforces the same regex; surfacing the pattern here lets the generated client validate before the round-trip. ")
    display_name: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(description="Human-readable Blueprint name. Whitespace-only is rejected.")
    description: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Optional free-form Blueprint description.")
    domain_id: Optional[UUID] = Field(default=None, description="Owning Domain when the Blueprint is scoped to a single Domain. Omit for a catalogue-wide entry. ")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["slug", "display_name", "description", "domain_id"]
