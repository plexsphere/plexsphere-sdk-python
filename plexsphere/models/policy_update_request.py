...
class PolicyUpdateRequest(BaseModel):
    ...
    expected_revision_id: Optional[UUID] = Field(default=None, description="Revision identifier the client believes is current. When present, the PATCH only succeeds if the persisted head still matches; otherwise the call surfaces as `409 revision_conflict`. ")
