...
class AuditEntryList(BaseModel):
    ...
    """ # noqa: E501
    items: List[AuditEntry] = Field(description="Audit rows in ascending `seq` order.")
    next_cursor: Optional[StrictStr] = Field(default=None, description="Opaque, HMAC-signed cursor scoped to the addressed chain. Replaying a cursor minted for a different chain surfaces as 400 with `code: invalid_cursor`. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [AuditEntry.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
