...
class AuditEntryList(BaseModel):
    ...
    """ # noqa: E501
    entries: List[AuditEntry] = Field(description="Audit rows in ascending `seq` order.")
    next_cursor: Optional[StrictStr] = Field(default=None, description="Opaque, HMAC-signed cursor scoped to the addressed Domain. Replaying a cursor minted for a different Domain surfaces as 400 with `code: cursor_invalid`. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [AuditEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
