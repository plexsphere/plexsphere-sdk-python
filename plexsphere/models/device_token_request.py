...
class DeviceTokenRequest(BaseModel):
    ...
    """ # noqa: E501
    device_code: Annotated[str, Field(strict=True, max_length=4096)] = Field(description="Device code returned by /v1/auth/device-code.")
    ...
    __properties: ClassVar[List[str]] = ["device_code", "client_id"]
