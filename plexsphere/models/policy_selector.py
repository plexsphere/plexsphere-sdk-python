...
class PolicySelector(BaseModel):
    ...
    """ # noqa: E501
    source: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Raw label-selector expression matching the originating side of governed traffic (e.g. `env=prod, role in (api, web)`). ")
    destination: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Raw label-selector expression matching the terminating side of governed traffic. ")
