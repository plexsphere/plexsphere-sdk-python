...
class CloudResponse(BaseModel):
    ...
    """ # noqa: E501
    id: UUID = Field(description="Cloud identifier (UUIDv7).")
    display_name: Annotated[str, Field(strict=True, max_length=256)] = Field(description="Human-readable Cloud name (trimmed at the aggregate).")
    slug: Annotated[str, Field(min_length=1, strict=True, max_length=63)] = Field(description="Kebab-case URL handle. Stable for the lifetime of the Cloud — see the `cloud` tag description for the immutability rationale. ")
