...
class NodeStateSession(BaseModel):
    """
    ...
    """ # noqa: E501
    session_id: UUID = Field(description="Identifier of the Session (UUIDv7).")
    ...
    __properties: ClassVar[List[str]] = ["session_id", "jti", "kind", "target", "expires_at", "idle_timeout_seconds"]
