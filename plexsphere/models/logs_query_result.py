...
class LogsQueryResult(BaseModel):
    ...
    body: StrictStr = Field(description="The logs backend's verbatim response body, carried as an opaque JSON string so the platform does not re-shape the backend's stream envelope. ")
