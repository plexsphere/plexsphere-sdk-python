...
class AuditRequestContext(BaseModel):
    ...
    """ # noqa: E501
    ip: Optional[StrictStr] = Field(default=None, description="Client IP after proxy unwrapping (IPv4 or IPv6 textual form).")
    user_agent: Optional[StrictStr] = Field(default=None, description="Verbatim `User-Agent` header value.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["ip", "user_agent"]
