...
class BridgeSiteToSiteTunnelList(BaseModel):
    ...
    """ # noqa: E501
    items: List[BridgeSiteToSiteTunnelResponse] = Field(description="Tunnels ordered by slug ascending.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [BridgeSiteToSiteTunnelResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
