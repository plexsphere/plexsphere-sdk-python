...
class Session(BaseModel):
    ...
    idle_timeout_seconds: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Idle window in whole seconds — the Session is reclaimed when `last_active_at + idle_timeout` passes. ")
