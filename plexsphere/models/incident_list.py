...
class IncidentList(BaseModel):
    ...
    """ # noqa: E501
    items: List[IncidentHeader] = Field(description="The incident headers on this page.")
    next_cursor: Optional[StrictStr] = Field(default=None, description="Opaque pagination cursor for the next page, or absent when the page is the last. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [IncidentHeader.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
