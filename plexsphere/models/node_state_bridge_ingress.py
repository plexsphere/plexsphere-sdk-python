...
class NodeStateBridgeIngress(BaseModel):
    """
    ...
    """ # noqa: E501
    rules: List[BridgeIngressRuleResponse] = Field(description="Public-ingress rules ordered by slug ascending.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rules": [BridgeIngressRuleResponse.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
