...
class NodeStateBridgeSiteToSite(BaseModel):
    """
    ...
    """ # noqa: E501
    tunnels: List[BridgeSiteToSiteTunnelResponse] = Field(description="Site-to-site tunnels ordered by slug ascending.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["tunnels"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tunnels": [BridgeSiteToSiteTunnelResponse.from_dict(_item) for _item in obj["tunnels"]] if obj.get("tunnels") is not None else None
        })
