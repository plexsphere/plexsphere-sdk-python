...
class NodeStateReportRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    value: Annotated[str, Field(strict=True, max_length=4096)] = Field(description="The report value to store for the addressed key. Capped at 4096 bytes; an over-size value is rejected with 400. ")
    workload_tag: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Optional tag of the workload producing the report. Stored verbatim and echoed back on the next reconciliation pull. ")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["value", "workload_tag"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": obj.get("value"),
            "workload_tag": obj.get("workload_tag")
        })
