...
class LabelSelectorPreviewRequest(BaseModel):
    """
    Body for POST /v1/labels/selectors/preview. Carries the raw selector expression to parse. 
    """ # noqa: E501
    expression: Annotated[str, Field(strict=True, max_length=4096)] = Field(description="Raw label-selector expression (for example `env=prod, owner in (alice, bob)`). ")
