...
class BootstrapTokenList(BaseModel):
    ...
    next_cursor: Optional[StrictStr] = Field(default=None, description="Continuation token for the next page. Absent when the iteration has reached end-of-stream. ")
