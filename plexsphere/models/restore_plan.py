...
class RestorePlan(BaseModel):
    ...
    """ # noqa: E501
    sequence: List[RestoreStep] = Field(description="The ordered restore steps, contiguous ascending by `order` starting at 1. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sequence": [RestoreStep.from_dict(_item) for _item in obj["sequence"]] if obj.get("sequence") is not None else None
        })
