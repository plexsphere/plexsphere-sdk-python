...
class AuditSubject(BaseModel):
    ...
    identity_id_ref: Optional[UUID] = Field(default=None, description="Live Identity id the pseudonym maps to; absent if the mapping has been erased. Cleared by `EraseIdentityFromAudit`. ")
