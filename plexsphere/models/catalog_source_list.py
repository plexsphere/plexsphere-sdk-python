...
class CatalogSourceList(BaseModel):
    ...
    """ # noqa: E501
    items: List[CatalogSourceResponse] = Field(description="Registered catalog sources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CatalogSourceResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
