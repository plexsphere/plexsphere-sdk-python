...
class ObjectSearchResponse(BaseModel):
    ...
    """ # noqa: E501
    items: List[ObjectSearchResultItem] = Field(description="Page of matched, access-checked object references. May be shorter than the requested `limit` because the ReBAC filter runs after pagination. ")
    next_cursor: Optional[StrictStr] = Field(default=None, description="Opaque cursor for the next page, or empty when this is the last page. ")
    correlation_id: StrictStr = Field(description="Correlation id pairing this search with the matching audit entry emitted by `internal/audit`. ")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["items", "next_cursor", "correlation_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ObjectSearchResultItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
