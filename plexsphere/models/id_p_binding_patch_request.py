...
class IdPBindingPatchRequest(BaseModel):
    ...
    alias: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Set or clear the binding alias. An empty string clears the alias; a non-empty value is normalised to lowercase kebab-case. The alias is unique per Domain among active bindings; a collision is rejected with 409 alias-conflict. ")
