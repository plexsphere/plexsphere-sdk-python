...
class LookupSubjectsRequest(BaseModel):
    ...
    """ # noqa: E501
    subject_type: Annotated[str, Field(min_length=1, strict=True, max_length=4096)] = Field(description="Object type whose instances are enumerated (e.g. `user`, `service-identity`). Returned `items` are `<subject_type>:<id>` object references. ")
    ...
    resource: Annotated[str, Field(min_length=1, strict=True, max_length=4096)] = Field(description="Object reference of the resource whose authorised subjects are enumerated (e.g. `project:0190a8b8-...`, `domain:...`). ")
