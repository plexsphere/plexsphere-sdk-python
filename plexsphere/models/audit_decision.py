...
class AuditDecision(BaseModel):
    ...
    """ # noqa: E501
    result: AuditReason
    caveat_context: Dict[str, List[StrictStr]] = Field(description="Map from caveat NAME to the array of caveat-parameter NAMES referenced by the check. Values are never present on the wire — the constraint is structural: the only string content here is identifiers. `internal/audit.Entry` and `internal/audit.AppendInput` enforce the same discipline structurally on the Go side. ")
