...
class ApprovalPolicy(BaseModel):
    ...
    """ # noqa: E501
    rules: Optional[List[ApprovalPolicyRulesInner]] = Field(default=None, description="Matching rules. A nil or empty list is the empty policy and gates no action. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rules": [ApprovalPolicyRulesInner.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
