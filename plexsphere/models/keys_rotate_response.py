...
class KeysRotateResponse(BaseModel):
    ...
    wrap_key_version: StrictInt = Field(description="Version of the active wrap key under which the re-issued PSK was wrapped. Paired with `kid` it pins the exact wrapping epoch. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kid": obj.get("kid"),
            "wrap_key_version": obj.get("wrap_key_version")
        })
