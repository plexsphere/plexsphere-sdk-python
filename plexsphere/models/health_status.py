...
class HealthStatus(BaseModel):
    ...
    """ # noqa: E501
    status: StrictStr = Field(description="Overall rollup of every sub-component check.")
    checks: List[HealthCheck] = Field(description="Per-dependency health checks.")
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ok', 'degraded', 'down']):
            raise ValueError("must be one of enum values ('ok', 'degraded', 'down')")
        return value
