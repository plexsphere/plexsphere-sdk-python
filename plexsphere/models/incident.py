...
class Incident(BaseModel):
    ...
    timeline: List[TimelineEvent] = Field(description="The incident's append-only timeline, ordered by `occurred_at` ascending. Only the single-incident read carries it; the list surface returns `IncidentHeader`. ")
