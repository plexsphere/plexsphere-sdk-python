...
class DomainReachabilityPolicy(BaseModel):
    """
    ...
    """ # noqa: E501
    heartbeat_interval: StrictStr = Field(description="Cadence agents must honour. Floor 10s, ceiling 1h. Encoded as a Go duration string (e.g. `30s`, `1m`). ")
    stale_after: StrictStr = Field(description="Grace window before a Node is declared stale. Must be at least `3 × heartbeat_interval` and at most 1h. ")
    unreachable_after: StrictStr = Field(description="Grace window before a Node is declared unreachable. Must be at least `2 × stale_after` and at most 1h. ")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["heartbeat_interval", "stale_after", "unreachable_after"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "heartbeat_interval": obj.get("heartbeat_interval"),
            "stale_after": obj.get("stale_after"),
            "unreachable_after": obj.get("unreachable_after")
        })
