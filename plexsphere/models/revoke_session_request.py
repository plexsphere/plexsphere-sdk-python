...
class RevokeSessionRequest(BaseModel):
    ...
    """ # noqa: E501
    revoke_reason: OperatorRevokeReason = Field(description="Reason for the revocation. The schema is the operator-driven subset of `RevokeReason` — the sweeper reasons (`ttl_expired`, `idle_timeout`) are set internally, never by this call, so a request carrying one fails validation instead of reaching the handler. ")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["revoke_reason"]
