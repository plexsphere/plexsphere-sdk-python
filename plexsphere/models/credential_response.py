...
class CredentialResponse(BaseModel):
    ...
    """ # noqa: E501
    id: UUID = Field(description="Credential identifier (UUIDv7).")
    ...
    __properties: ClassVar[List[str]] = ["id", "project_id", "version", "status", "expires_at", "revoked_at", "expired_at", "created_at", "updated_at"]
