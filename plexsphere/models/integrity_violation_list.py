...
class IntegrityViolationList(BaseModel):
    ...
    next_cursor: Optional[StrictStr] = Field(default=None, description="Continuation token for the next page. Absent when the iteration has reached end-of-stream. The encoding is HMAC-signed so a tampered cursor surfaces as `400` on the next call. ")
