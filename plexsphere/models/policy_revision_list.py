...
class PolicyRevisionList(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [PolicyRevision.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
