...
class ServiceTokenResponse(BaseModel):
    ...
    """ # noqa: E501
    access_token: StrictStr = Field(description="Access token suitable for Bearer-authenticated requests.")
    token_type: StrictStr = Field(description="Always \"Bearer\" for plexsphere-issued tokens.")
    expires_in: Annotated[int, Field(strict=True, ge=1)] = Field(description="Lifetime of the access token in seconds.")
    scope: Optional[StrictStr] = Field(default=None, description="Space-delimited scope string, when one was granted.")
