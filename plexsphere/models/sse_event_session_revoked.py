...
class SSEEventSessionRevoked(BaseModel):
    """
    ...
    """ # noqa: E501
    session_id: UUID = Field(description="Identifier of the revoked Session (UUIDv7).")
    jti: StrictStr = Field(description="The revoked token's `jti`. Equals the session identifier. ")
    revoked_at: datetime = Field(description="Revocation timestamp (UTC).")
    revoke_reason: RevokeReason
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["session_id", "jti", "revoked_at", "revoke_reason"]
