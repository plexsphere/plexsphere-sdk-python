...
class PolicyPortRange(BaseModel):
    """
    ...
    """ # noqa: E501
    var_from: Annotated[int, Field(le=65535, strict=True, ge=1)] = Field(alias="from")
    to: Annotated[int, Field(le=65535, strict=True, ge=1)]
