...
class BridgeRelayConfigureRequest(BaseModel):
    ...
    listen_port: Annotated[int, Field(le=65535, strict=True, ge=1)] = Field(description="UDP port the relay listens on. Outside `1..65535` the write is rejected with `400 port_out_of_range`. ")
