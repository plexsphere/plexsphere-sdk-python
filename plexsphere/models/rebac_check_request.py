...
class RebacCheckRequest(BaseModel):
    ...
    """ # noqa: E501
    subject: Annotated[str, Field(min_length=1, strict=True, max_length=4096)] = Field(description="Object reference of the subject performing the check (e.g. `user:0190a8b8-...`, `service-identity:...`). ")
    relation: Annotated[str, Field(min_length=1, strict=True, max_length=4096)] = Field(description="Relation name to evaluate (e.g. `read`, `manage`, `maintainer`). The accepted set is fixed by the schema in `schema/authz.zed`. ")
    resource: Annotated[str, Field(min_length=1, strict=True, max_length=4096)] = Field(description="Object reference of the resource the relation is evaluated against (e.g. `project:0190a8b8-...`, `domain:...`). ")
