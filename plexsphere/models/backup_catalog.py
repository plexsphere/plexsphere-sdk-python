...
class BackupCatalog(BaseModel):
    ...
    """ # noqa: E501
    entries: List[BackupCatalogEntry] = Field(description="The per-store coverage table.")
    targets: List[BackupTarget] = Field(description="The recovery objectives per plane.")
    exclusions: List[BackupExclusion] = Field(description="What the platform deliberately does not back up.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["entries", "targets", "exclusions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [BackupCatalogEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "targets": [BackupTarget.from_dict(_item) for _item in obj["targets"]] if obj.get("targets") is not None else None,
            "exclusions": [BackupExclusion.from_dict(_item) for _item in obj["exclusions"]] if obj.get("exclusions") is not None else None
        })
