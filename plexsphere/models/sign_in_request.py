...
class SignInRequest(BaseModel):
    ...
    """ # noqa: E501
    domain_id: Optional[UUID] = Field(default=None, description="Domain the user is signing into.")
    idp_binding_id: Optional[UUID] = Field(default=None, description="Explicit IdP binding override within a Domain.")
    return_to: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Post-sign-in redirect target. Must be an allow-listed relative path or absolute URL. ")
    prompt: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Optional OIDC `prompt` parameter forwarded to the IdP (e.g. \"login\", \"consent\"). ")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["domain_id", "idp_binding_id", "return_to", "prompt"]
