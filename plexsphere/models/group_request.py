...
class GroupRequest(BaseModel):
    ...
    idp_claim_value: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Verbatim IdP claim value the Group reconciles to. Required when `source=idp`; must be omitted when `source=manual`. ")
