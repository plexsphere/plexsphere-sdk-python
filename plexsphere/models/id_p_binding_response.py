...
class IdPBindingResponse(BaseModel):
    ...
    domain_id: Optional[UUID] = Field(default=None, description="Owning Domain; absent for a platform-scoped (shared) binding usable by any Domain. ")
    ...
    required_acr: Optional[Annotated[List[StrictStr], Field(max_length=16)]] = None
    required_amr: Optional[Annotated[List[StrictStr], Field(max_length=16)]] = None
