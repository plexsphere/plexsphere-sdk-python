...
class ExecutionCallbackRequest(BaseModel):
    ...
    error: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Free-text error the action reported. Present on a `failed` terminal callback. ")
    declared_output_bytes: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Size in bytes the Node declares it intends to upload. A value over the 16 KiB ceiling drives the over-ceiling presign mint on the first callback. ")
