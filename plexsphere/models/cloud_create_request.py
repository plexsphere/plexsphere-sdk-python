...
class CloudCreateRequest(BaseModel):
    ...
    external_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Upstream provider account identifier. Combined with `provider` must be unique across all Clouds. ")
