...
class BridgeUserAccessProviderList(BaseModel):
    ...
    """ # noqa: E501
    items: List[BridgeUserAccessProviderResponse] = Field(description="Providers ordered by slug ascending.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [BridgeUserAccessProviderResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
