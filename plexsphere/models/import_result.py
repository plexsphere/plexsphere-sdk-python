...
class ImportResult(BaseModel):
    ...
    """ # noqa: E501
    outcomes: List[ImportOutcome] = Field(description="One entry per requested Blueprint slug.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outcomes": [ImportOutcome.from_dict(_item) for _item in obj["outcomes"]] if obj.get("outcomes") is not None else None
        })
