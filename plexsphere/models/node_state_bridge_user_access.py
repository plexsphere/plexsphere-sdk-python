...
class NodeStateBridgeUserAccess(BaseModel):
    """
    ...
    """ # noqa: E501
    providers: List[BridgeUserAccessProviderResponse] = Field(description="User-access providers ordered by slug ascending.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providers": [BridgeUserAccessProviderResponse.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None
        })
