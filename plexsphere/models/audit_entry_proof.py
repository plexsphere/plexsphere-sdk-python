...
class AuditEntryProof(BaseModel):
    """
    ...
    """ # noqa: E501
    entry: AuditEntry
    proof: AuditEntryProofProof
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["entry", "proof"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entry": AuditEntry.from_dict(obj["entry"]) if obj.get("entry") is not None else None,
            "proof": AuditEntryProofProof.from_dict(obj["proof"]) if obj.get("proof") is not None else None
        })
